...
WO-06 Foundation (Opus worktree). When it merges: WO-07 mirror + WO-08 reveal/film + WO-13 QA in parallel (disjoint files; WO-13 must NOT touch STATUS.md), then Fable's pass.
