...
export async function run(t) {
  ...
  const fr = frames(S.log, 21, 24, { eras: [origins], cfg });
  ...
  const t0 = process.hrtime.bigint(); frames(S.log, 21, 288, { eras: [origins], cfg, chunk: 16 }); const ms = Number(process.hrtime.bigint() - t0) / 1e6;
